...
<head>
    ...
    <title>Add new Data Products - Poliban</title>
...
<body style="background: lightgray">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" row="5" placeholder="Masukkan Description product">{{ old('description')}}</textarea>
    ...
    <script src="https://cdn.fsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
